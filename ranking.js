    ...
    client.on("message", async (message) => {
        ...
        function levelinghelp() {
            const embed = new Discord.MessageEmbed()
                ...
                .addFields([{
                        name: "`rank [@User]`",
                        value: ">>> *يظهر رتبة المستخدم*",
                        inline: true
                    },
                    {
                        name: "`leaderboard`",
                        value: ">>> *يعرض قائمة المتصدرين العشرة الأوائل*",
                        inline: true
                    },
                    {
                        name: "`setxpcounter <@USER> <AMOUNT>`",
                        value: ">>> *يغير مقدار مقدار العد ، x1 ، x2 ، x3 ، ...*",
                        inline: true
                    },

                    {
                        name: "`addpoints <@User> <Amount`",
                        value: ">>> *أضف كمية محددة من النقاط إلى المستخدم*",
                        inline: true
                    },
                    {
                        name: "`setpoints <@User> <Amount`",
                        value: ">>> *قم بتعيين كمية محددة من النقاط للمستخدم*",
                        inline: true
                    },
                    {
                        name: "`removepoints <@User> <Amount`",
                        value: ">>> *قم بإزالة كمية محددة من النقاط للمستخدم*",
                        inline: true
                    },

                    {
                        name: "`addlevel <@User> <Amount`",
                        value: ">>> *أضف مقدارًا محددًا من المستويات إلى المستخدم*",
                        inline: true
                    },
                    {
                        name: "`setlevel <@User> <Amount`",
                        value: ">>> *قم بتعيين مقدار محدد من المستويات للمستخدم*",
                        inline: true
                    },
                    {
                        name: "`removelevel <@User> <Amount`",
                        value: ">>> *قم بإزالة مقدار معين من المستويات للمستخدم*",
                        inline: true
                    },

                    {
                        name: "`resetranking <@User>`",
                        value: ">>> *يعيد ترتيب ترتيب المستخدم*",
                        inline: true
                    },
                    {
                        name: "`setglobalxpcounter <AMOUNT>`",
                        value: ">>> *يضبط عداد xp العمومي لهذه النقابة ، القياسي 1*",
                        inline: true
                    },
                    {
                        name: "\u200b",
